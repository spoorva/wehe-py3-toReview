...
class ClientObj(object):
    ...
    def setTraceRoute(self, name):
        if not os.path.exists(self.tracerouteFolder):
            os.makedirs(self.tracerouteFolder)
...
class SideChannel(object):
    ...
    def handle(self, connection, address):
		...
		#this one works, comment line 929
        #dClient.setTraceRoute('')
        #print("RUNNING TRACEROUTE! on line 834")
    ...
    def side_channel_callback(self, *args):
		...
		#doesn't work
        #print("RUNNING TRACEROUTE! on line 1264")
        #tracerouteRes = dClient.trc_rt.start()
        ...
        #doesn't work!		
        #print("RUNNING TRACEROUTE! on line 1285")
        #tracerouteRes = dClient.trc_rt.start()
